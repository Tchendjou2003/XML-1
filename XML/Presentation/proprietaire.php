...
<div
 class="content1">
	<form class="form" method="POST" action="../Traitement/modif.php">
		<div class="title1">Modifier proprietaire</div>
		<div class="field1">
			<div class="test">
		...
		<div class="field1">
			<div class="test">
				...
				<input type="text" name="CA" id="CA" value="<?php echo $val9; ?>">
			</div>
			<div class="test">
				<label for="mail">E-mail</label>
				<input type="email" name="mail" id="mail" value="<?php echo $val10; ?>">
			</div>
		</div>
		<div>
		...
		<div class="field1" id="un">
			...
			<div class="test">
				<input type="submit" name="proprietaire" value="Modifier" class="in">
			</div>
		</div>
	</form>
</div>
